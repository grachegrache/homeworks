...
// 
{
	public:
		...
		virtual int Pack(const char * field, int size = -1) = 0; // set the value of the next field of the buffer;
		virtual int Unpack(char * field, int maxbytes = -1) = 0; // extract the value of the next field of the buffer
